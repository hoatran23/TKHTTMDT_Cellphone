		...
		<div class="col-md-12">
			<div class="card">
				<div class="card-header text-center">
					<a href="{{asset('admin/order/waiting_confirm')}}" class="btn btn-warning" style="background-color: #fcc468">Order Waiting Confirm</a>
				...
				<div class="card-body">
					...
					<div>
						<table class="table table-bordered">
                            <h4 style="text-align: center;" class="mb-2">Đơn Hàng Đã Xác Nhận</h4>
					...
					<div id="pagination" class="text-center text-primary">
						<div class="pagination-wrap">
							{{$confirmed->appends(['confirmed' => $confirmed->currentPage()])->links('vendor.pagination.bootstrap-4')}}
						</div>
					</div>
