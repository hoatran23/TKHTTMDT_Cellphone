...
@section('title', 'Danh Sách Đơn Hàng Gặp Vấn Đề')
@section('main')
		...
		<div class="col-md-12">
			<div class="card">
				...
				<div class="card-body">
					<!-- Hẹn ngày giao lại -->
					<div>
                        <h4 style="text-align: center;" class="mb-2">Đơn Hàng Có Vấn Đề Phát Sinh</h4>
								...
								@foreach($trouble as $order)
									...
									<div id="pagination" class="text-center text-primary">
										<div class="pagination-wrap">
											{{$trouble->appends(['trouble' => $trouble->currentPage()])->links('vendor.pagination.bootstrap-4')}}
										</div>
									</div>
