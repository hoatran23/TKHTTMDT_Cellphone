		...
		<div class="col-md-12">
			<div class="card">
				...
				<div class="card-body">
					<!-- Chờ xác nhận -->
					<div>
						<h4 style="text-align: center;" class="mb-2">Đơn Hàng Chờ Xác Nhận</h4>
						<table class="table table-bordered">
							...
							<tbody>
								@foreach($waiting_confirm as $order)
					...
					<div id="pagination" class="text-center text-primary">
						<div class="pagination-wrap">
							{{$waiting_confirm->appends(['waiting_confirm' => $waiting_confirm->currentPage()])->links('vendor.pagination.bootstrap-4')}}
						</div>
					</div>
